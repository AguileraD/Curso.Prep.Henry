...
function esPositivo(numero) {
  ...
  if (numero>0){return "Es positivo"}else if (numero<0) {return "Es negativo"} else (numero===0); {return false}
}
...
function esVocal(letra){
  ...
  //Escribe tu código aquí
  if(letra.length>1){return "Dato incorrecto"}else if(letra=='a'||letra=='e'||letra=='i'||letra=='o'||letra=='u'){return "Es vocal"
} else {
